...
enum L10n {
    ...
    static let table: [String: [AppLang: String]] = [
        ...
        "home.top_movies":  [.ar: "الأعلى تقييماً · أفلام", .en: "Top Rated Movies", .fr: "Films les mieux notés", .tr: "En Çok Beğenilen Filmler", .es: "Películas mejor valoradas"],
        "home.top_series":  [.ar: "الأعلى تقييماً · مسلسلات", .en: "Top Rated Series", .fr: "Séries les mieux notées", .tr: "En Çok Beğenilen Diziler", .es: "Series mejor valoradas"],
