...
DESCRIPTION = """Trex TV — مشغّل وسائط للآيفون والآيباد، مبنيّ للسرعة والوضوح.
...
ملاحظة مهمة
Trex TV مشغّل فقط. لا يوفّر ولا يستضيف أي قنوات أو أفلام أو محتوى، ولا يأتي بأي محتوى مدمج. يلزمك اشتراك خاص من مزوّد مرخّص، وأنت وحدك مسؤول عن اشتراكك وعن مشروعية ما تصل إليه.
